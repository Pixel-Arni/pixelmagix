...
// Component Implementations würden hier folgen...
// SectionRenderer, SectionsPanel, PropertiesPanel, AIPanel

// Placeholder Components
function SectionRenderer({ section, isSelected, isPreviewMode, onClick, onDelete }: any) {
  return (
    <div 
      className={cn(
...
function SectionsPanel({ templates, onAddSection }: any) {
  return (
...
function PropertiesPanel({ section, onChange }: any) {
  if (!section) {
    return (
