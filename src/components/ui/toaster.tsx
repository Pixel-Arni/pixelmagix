...
export function createToast() {
  ...
  const ensureContainer = () => {
    if (!toastContainer) {
      ...
      toastContainer.className = 'fixed bottom-0 right-0 z-50 p-4 space-y-2'
  ...
  const addToast = (toast: Omit<Toast, 'id'>) => {
    ...
    // Hier würde normalerweise React.render verwendet werden
    // Für standalone usage ohne React Context
    console.warn('createToast sollte nur mit ToastProvider verwendet werden')
